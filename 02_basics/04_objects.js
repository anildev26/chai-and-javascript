...
console.log(tinderUser); // Original Object
console.log(Object.keys(tinderUser)); // keys returned as an Array
console.log(Object.values(tinderUser)); // values returned as an Array
